...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200166:	7ba0006f          	j	80200920 <sbi_console_putchar>
...
void idt_init(void)
{
    ...
    80200178:	30878793          	addi	a5,a5,776 # 8020047c <__alltraps>
    ...
    80200182:	610c                	ld	a1,0(a0)
{
    ...
    8020018e:	92e50513          	addi	a0,a0,-1746 # 80200ab8 <etext+0x11c>
{
    ...
    80200346:	a5e50513          	addi	a0,a0,-1442 # 80200da0 <etext+0x404>
}
    ...
    80200352:	85aa                	mv	a1,a0
{
    ...
    8020035a:	a6250513          	addi	a0,a0,-1438 # 80200db8 <etext+0x41c>
{
    ...
    802003a6:	a7650513          	addi	a0,a0,-1418 # 80200e18 <etext+0x47c>
}
...
void interrupt_handler(struct trapframe *tf)
{
    ...
    802003c0:	b2470713          	addi	a4,a4,-1244 # 80200ee0 <etext+0x544>
    ...
    802003d2:	ac250513          	addi	a0,a0,-1342 # 80200e90 <etext+0x4f4>
    802003d6:	b951                	j	8020006a <cprintf>
        cprintf("Hypervisor software interrupt\n");
    802003d8:	00001517          	auipc	a0,0x1
    802003dc:	a9850513          	addi	a0,a0,-1384 # 80200e70 <etext+0x4d4>
    802003e0:	b169                	j	8020006a <cprintf>
        cprintf("User software interrupt\n");
    802003e2:	00001517          	auipc	a0,0x1
    802003e6:	a4e50513          	addi	a0,a0,-1458 # 80200e30 <etext+0x494>
    802003ea:	b141                	j	8020006a <cprintf>
        cprintf("Supervisor software interrupt\n");
    802003ec:	00001517          	auipc	a0,0x1
    802003f0:	a6450513          	addi	a0,a0,-1436 # 80200e50 <etext+0x4b4>
    ...
    802003fa:	c1a78793          	addi	a5,a5,-998 # 80204010 <ticks>
    802003fe:	6398                	ld	a4,0(a5)
{
    80200400:	1141                	addi	sp,sp,-16
    80200402:	e022                	sd	s0,0(sp)
    80200404:	e406                	sd	ra,8(sp)
        ticks++;
    80200406:	0705                	addi	a4,a4,1
    80200408:	e398                	sd	a4,0(a5)
        if (ticks == TICK_NUM)
    8020040a:	639c                	ld	a5,0(a5)
    8020040c:	06400693          	li	a3,100
    80200410:	00004417          	auipc	s0,0x4
    80200414:	c0840413          	addi	s0,s0,-1016 # 80204018 <num>
    80200418:	02d78063          	beq	a5,a3,80200438 <interrupt_handler+0x8a>
        {
            print_ticks();
            ticks = 0;
            num++;
    ...
    80200420:	02f70c63          	beq	a4,a5,80200458 <interrupt_handler+0xaa>
        break;
    default:
        print_trapframe(tf);
        break;
    ...
    80200440:	a7450513          	addi	a0,a0,-1420 # 80200eb0 <etext+0x514>
    ...
    80200456:	b7d9                	j	8020041c <interrupt_handler+0x6e>
}
...
void trap(struct trapframe *tf) { trap_dispatch(tf); }
    80200476:	8082                	ret
        print_trapframe(tf);
    80200478:	bdd9                	j	8020034e <print_trapframe>
        interrupt_handler(tf);
    8020047a:	bf15                	j	802003ae <interrupt_handler>
